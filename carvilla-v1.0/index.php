		...
		<section id="home" class="welcome-hero">
			...
			<div class="container">
				<div class="welcome-hero-txt">
					<h2>mua xe bạn mong muốn với giá cả hợp lý</h2>
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-service-item">
								...
								<h2><a href="#">bảo hành sửa chữa trọn đời</a></h2>
								...
								<div class="row">
									...
									<div class="col-md-5 col-sm-12">
										<div class="new-cars-txt">
											...
											<p>
											Chevrolet Camaro ZA100 - Biểu tượng của sự mạnh mẽ và phong cách. Xe thể thao đầy cuốn hút với thiết kế năng động, động cơ mạnh mẽ và hiệu suất vượt trội. Với công nghệ tiên tiến, trải nghiệm lái tuyệt vời và khả năng tăng tốc đáng kinh ngạc, đây là lựa chọn hoàn hảo cho những người yêu thích tốc độ và cái nhìn độc đáo trong thế giới xe hơi. 
											</p>
								...
								<div class="row">
									...
									<div class="col-md-5 col-sm-12">
										<div class="new-cars-txt">
											...
											<p>
											BMW Series 3 Wagon - Sự kết hợp hoàn hảo giữa thể thao và tiện ích. Xe mang đến thiết kế đẹp mắt, không gian rộng rãi và khả năng chở hàng linh hoạt. Với công nghệ tiên tiến, trải nghiệm lái tuyệt vời và hiệu suất vượt trội, chiếc xe này là một sự lựa chọn đáng chú ý cho những người yêu thích sự tiện dụng và đẳng cấp của BMW. 
											</p>
								...
								<div class="row">
									...
									<div class="col-md-5 col-sm-12">
										<div class="new-cars-txt">
											...
											<p>
											Ferrari 488 Superfast - biểu tượng tốc độ và đẳng cấp. Với động cơ V8 tăng áp kép, công suất 710 mã lực, xe tăng tốc 0-100 km/h trong 2.9 giây. Thiết kế cuốn hút, nội thất sang trọng và trải nghiệm lái tuyệt vời.
											</p>
						...
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="single-featured-cars">
								...
								<div class="featured-cars-txt">
									...
									<h3>$89,395</h3>
									<p>
									BMW 6-Series Gran Coupe - Kết hợp thể thao và sang trọng, thiết kế đẹp mắt, động cơ mạnh mẽ và trải nghiệm lái tuyệt vời.
									</p>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="single-featured-cars">
								...
								<div class="featured-cars-txt">
									...
									<h3>$66,575</h3>
									<p>
									Chevrolet Camaro WMV20 - Biểu tượng thể thao với thiết kế cuốn hút, hiệu suất mạnh mẽ và trải nghiệm lái tuyệt vời.
									</p>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="single-featured-cars">
								...
								<div class="featured-cars-txt">
									...
									<h3>$125,250</h3>
									<p>
									Lamborghini V520 - Biểu tượng của tốc độ và sự đam mê, với thiết kế độc đáo, động cơ mạnh mẽ và trải nghiệm lái không thể quên. 
									</p>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="single-featured-cars">
								...
								<div class="featured-cars-txt">
									...
									<h3>$95,500</h3>
									<p>
									Audi A3 Sedan - Kết hợp hoàn hảo giữa hiệu suất và phong cách. Thiết kế tinh tế, công nghệ tiên tiến và trải nghiệm lái đáng nhớ. 
									</p>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="single-featured-cars">
								...
								<div class="featured-cars-txt">
									...
									<h3>$36,850</h3>
									<p>
									Infiniti Z5 - Sang trọng, hiệu suất, thiết kế độc đáo và trải nghiệm lái đáng nhớ.
									</p>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="single-featured-cars">
								...
								<div class="featured-cars-txt">
									...
									<h3>$48,500</h3>
									<p>
									Porsche 718 - Biểu tượng thể thao với thiết kế tinh tế, hiệu suất vượt trội và trải nghiệm lái đầy sảng khoái.
									</p>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="single-featured-cars">
								...
								<div class="featured-cars-txt">
									...
									<h3>$56,000</h3>
									<p>
									BMW 8 Series Coupe - Sự kết hợp hoàn hảo giữa sang trọng và thể thao. Thiết kế đẹp mắt, động cơ mạnh mẽ và trải nghiệm lái tuyệt vời. 
									</p>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="single-featured-cars">
								...
								<div class="featured-cars-txt">
									...
									<h3>$75,800</h3>
									<p>
									BMW X6 - Sự kết hợp độc đáo giữa SUV và thiết kế coupe. Xe mang đến không gian rộng rãi, hiệu suất mạnh mẽ và phong cách cá nhân. Với công nghệ tiên tiến và trải nghiệm lái thú vị, BMW X6 là sự lựa chọn tuyệt vời cho những người yêu thích sự sang trọng và sức mạnh của dòng xe BMW.
									</p>
								</div>
							</div>
						</div>
			...
			<div class="container">
				...
				<div class="footer-copyright">
					<div class="row">
						<div class="col-sm-6">
							<p>
								&copy; copyright.designed and developed by Group 7
							</p><!--/p-->
						</div>
						<div class="col-sm-6">
